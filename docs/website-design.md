...
## Initial public deployment — 2026-09-13

User explicitly approved current version for GitHub hosting. Main fast-forwarded to06a5abc. GitHub Pages enabled with build_type=workflow and HTTPS enforced. Workflow run https://github.com/rouicezar/FormaBot/actions/runs/34760436129 succeeded. Live URL https://rouicezar.github.io/FormaBot/ verified HTTP200; live browser English default, Chinese text/image switching and image availability verified. Initial website accepted for publication; App release gates remain unchanged. Future deployment is manual via pages.yml.
